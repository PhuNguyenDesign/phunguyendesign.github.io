...
export default function SchemaMobilePage() {
  return (
    <CaseStudyPage>
      ...
      <Section title="01 – The Open edX mobile app">
        <Body>
      ...
      <Section title="Visual course progress">
        <Body>
      ...
      <Section title="Designing the system around the screens">
        <Body last>
      ...
      <Section title="What I took away" last>
        <CardGrid
          min={260}
          items={[
            { name: "Progress should point somewhere", body: "A progress bar is only useful if it helps learners decide what to do next. That's why the CTA cards mattered as much as the visuals." },
